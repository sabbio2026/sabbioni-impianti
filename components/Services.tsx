...
const svc = [
  ...
  { icon: Shield,   title: "Impianti Speciali",   sub: "Sicurezza · TVCC · Domotica",        color: "#4A90D9",
    desc: "Videosorveglianza IP 4K, antintrusione, controllo accessi, fire detection e building automation per ambienti civili e industriali.",
    tags: ["TVCC 4K", "Antintrusione", "KNX/BACnet", "Fire Detection"] },
