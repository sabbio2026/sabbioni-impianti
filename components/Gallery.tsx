...
const photos: { src: string; cat: Exclude<Cat, "Tutti">; alt: string }[] = [
  // — Residenziale —
  { src: "/gallery/r01.jpg", cat: "Residenziale", alt: "Soggiorno — LED geometrico a soffitto" },
  { src: "/gallery/r02.jpg", cat: "Residenziale", alt: "Sala pranzo — plafoniera LED circolare" },
  { src: "/gallery/r03.jpg", cat: "Residenziale", alt: "Soggiorno — soffitto con forme LED" },
  { src: "/gallery/r04.jpg", cat: "Residenziale", alt: "Ingresso e corridoio — LED strip e libreria" },
  { src: "/gallery/r05.jpg", cat: "Residenziale", alt: "Cucina — LED strip integrato" },
  { src: "/gallery/r06.jpg", cat: "Residenziale", alt: "Ingresso porta rossa — LED strip" },
  { src: "/gallery/r07.jpg", cat: "Residenziale", alt: "Scala — LED strip su arco" },
  { src: "/gallery/r08.jpg", cat: "Residenziale", alt: "Camera — LED geometrico triangolare" },
  { src: "/gallery/r09.jpg", cat: "Residenziale", alt: "Bagno in marmo travertino — LED warm" },
  { src: "/gallery/r10.jpg", cat: "Residenziale", alt: "Bagno doccia travertino — LED strip" },
  { src: "/gallery/r11.jpg", cat: "Residenziale", alt: "Domotica Vimar — pannello touchscreen" },
  { src: "/gallery/r12.jpg", cat: "Residenziale", alt: "Corridoio — illuminazione LED lineare" },
  { src: "/gallery/r13.jpg", cat: "Residenziale", alt: "Camera singola — LED strip verde" },
  { src: "/gallery/r14.jpg", cat: "Residenziale", alt: "Camera matrimoniale — LED e corridoio" },
  { src: "/gallery/r15.jpg", cat: "Residenziale", alt: "Bagni doppi in marmo travertino" },
  // — Commerciale / Industriale —
  { src: "/gallery/i01.jpg", cat: "Commerciale", alt: "Sala pubblica — illuminazione LED industriale" },
  { src: "/gallery/i02.jpg", cat: "Commerciale", alt: "Showroom — impianto luce LED su banco" },
  { src: "/gallery/i03.jpg", cat: "Commerciale", alt: "Showroom — pannelli LED sospesi" },
  { src: "/gallery/i04.jpg", cat: "Commerciale", alt: "Quadro elettrico BT — installazione" },
  { src: "/gallery/i05.jpg", cat: "Commerciale", alt: "Cabina MT/BT — manutenzione" },
];
